    ...
    <>
      ...
      <AnimatePresence>
        <motion.div
          ...
          className="fixed bottom-6 right-6 z-[90] bg-card/90 backdrop-blur-xl border border-rose-500/20 shadow-2xl rounded-2xl p-3 flex items-center gap-3 w-[260px]"
        >
