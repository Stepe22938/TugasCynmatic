...
import { Bot, Sparkles, ShieldCheck, AlertTriangle, XCircle, Loader2, ChevronDown, ChevronUp } from "lucide-react";
  ...
  const handleCheck = async () => {
    ...
    try {
      ...
      const res  = await fetch(`${base}/api/ai/check-product`, {
        ...
        body: JSON.stringify({ name: productName, description, price, category }),
      });
